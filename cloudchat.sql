...
(
  ...
  COLLATE = utf8mb4_unicode_ci COMMENT ='聊天信息存储表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT ='朋友圈表';
...
(
    ...
    `wechat_num`       varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '微信号',
    `account`          varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci                            NOT NULL COMMENT '登录账号（唯一）',
    `password`         varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci                           NOT NULL COMMENT '密码（加密存储）',
    `wechat_num_img`   varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '微信号二维码',
    `mobile`           varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '手机号',
    `nickname`         varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '昵称',
    `real_name`        varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '真实姓名',
    `sex`              int COMMENT '性别，1:男 0:女 2:保密',
    `face`             varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '用户头像',
